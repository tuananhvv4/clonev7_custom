...
$body = ["title" => __("Nhật ký hoạt động") . " | " . $CMSNT->site("title"), "desc" => $CMSNT->site("description"), "keyword" => $CMSNT->site("keywords")];
...
$urlDatatable = pagination_client(base_url("?action=logs&limit=" . $limit . "&shortByDate=" . $shortByDate . "&content=" . $content . "&time=" . $time . "&ip=" . $ip . "&device=" . $device . "&"), $from, $totalDatatable, $limit);
