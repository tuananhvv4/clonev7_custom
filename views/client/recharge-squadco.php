...
$body = ["title" => __("Recharge Squadco") . " | " . $CMSNT->site("title"), "desc" => $CMSNT->site("description"), "keyword" => $CMSNT->site("keywords")];
...
if(!empty($_GET["transaction_ref"])) {
    ...
    $where .= " AND `transaction_ref` = \"" . $transaction_ref . "\" ";
}
...
echo __("Recharge Squadco");
echo "</h4>\n                    <div class=\"text-center mb-4\">\n                        <img width=\"300px\" src=\"";
echo base_url("assets/img/logo-squadco.svg");
echo "\" />\n                    </div>\n                    <div class=\"row mb-3\">\n                        <label class=\"col-sm-4 col-form-label\"\n                            for=\"example-hf-email\">";
echo __("Enter the deposit amount: (" . $CMSNT->site("squadco_currency_code") . ")");
...
echo "\" />\n                            <input type=\"hidden\" id=\"transaction_ref\" value=\"";
echo uniqid();
echo "\" />\n                            <input type=\"text\" class=\"form-control\" id=\"amount\"\n                                placeholder=\"";
echo __("Please enter the amount to deposit");
echo "\" required>\n                        </div>\n                    </div>\n                    <center>\n                        <div class=\"wallet-form\">\n                            <button type=\"button\" onclick=\"SquadPay()\" id=\"btnSubmit\">";
echo __("Submit");
echo "</button>\n                        </div>\n                    </center>\n                </div>\n            </div>\n            <div class=\"col-md-5\">\n                <div class=\"account-card\">\n                    <h4 class=\"account-title\">";
echo __("Lưu ý");
echo "</h4>\n                    ";
