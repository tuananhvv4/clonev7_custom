...
$body = ["title" => __("Nạp tiền bằng ví MOMO") . " | " . $CMSNT->site("title"), "desc" => $CMSNT->site("description"), "keyword" => $CMSNT->site("keywords")];
...
echo __("Nạp tiền bằng ví MOMO");
echo "</h3>\n                        ";
if($CMSNT->site("momo_number") != "") {
    echo "                        ";
    echo file_get_contents("https://api.web2m.com/api/qrmomo.php?amount=10000&phone=" . $CMSNT->site("momo_number") . "&noidung=" . urlencode($CMSNT->site("prefix_autobank")) . $getUser["id"] . "&size=300");
    echo "                        ";
}
