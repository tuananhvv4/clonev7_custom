...
$body = ["title" => __("Recharge Crypto"), "desc" => "CMSNT Panel", "keyword" => "cmsnt, CMSNT, cmsnt.co,"];
$body["header"] = "\n \n\n";
$body["footer"] = "\n \n";
...
if(isset($_POST["SaveSettings"])) {
    ...
    $CMSNT->insert("logs", ["user_id" => $getUser["id"], "ip" => myip(), "device" => $Mobile_Detect->getUserAgent(), "createdate" => gettime(), "action" => __("Cấu hình nạp tiền Crypto")]);
    ...
    $currentYear = date("Y");
    $currentDate = date("Y-m-d");
    $total_yesterday = (int) $CMSNT->get_row("SELECT SUM(received) FROM payment_crypto WHERE  `status` = 'completed' AND `create_gettime` LIKE '%" . $yesterday . "%' ")["SUM(received)"];
    ...
    echo $CMSNT->site("crypto_status") == 1 ? "selected" : "";
    echo "                                                value=\"1\">ON\n                                            </option>\n                                            <option ";
    echo $CMSNT->site("crypto_status") == 0 ? "selected" : "";
    echo "                                                value=\"0\">OFF\n                                            </option>\n                                        </select>\n                                    </div>\n                                </div>\n                                <div class=\"row mb-4\">\n                                    <label class=\"col-sm-4 col-form-label\" for=\"example-hf-email\">Address</label>\n                                    <div class=\"col-sm-8\">\n                                        <input type=\"text\" class=\"form-control\"\n                                            value=\"";
    echo $CMSNT->site("crypto_address");
    echo "\" name=\"crypto_address\"\n                                            placeholder=\"";
    echo __("Enter the wallet address to connect");
    ...
    echo $CMSNT->site("crypto_token");
    echo "\" name=\"crypto_token\"\n                                            placeholder=\"";
    echo __("Enter verification token at API");
    echo "\">\n                                    </div>\n                                </div>\n                            </div>\n                            <div class=\"col-lg-12 col-xl-6\">\n                                <div class=\"row mb-4\">\n                                    <label class=\"col-sm-6 col-form-label\"\n                                        for=\"example-hf-email\">";
    echo __("Nạp tối thiểu");
    echo "</label>\n                                    <div class=\"col-sm-6\">\n                                        <input type=\"text\" class=\"form-control\" value=\"";
    echo $CMSNT->site("crypto_min");
    echo "\"\n                                            name=\"crypto_min\" placeholder=\"VD: 10\">\n                                    </div>\n                                </div>\n                                <div class=\"row mb-4\">\n                                    <label class=\"col-sm-6 col-form-label\"\n                                        for=\"example-hf-email\">";
    echo __("Nạp tối đa");
    echo "</label>\n                                    <div class=\"col-sm-6\">\n                                        <input type=\"text\" class=\"form-control\" value=\"";
    echo $CMSNT->site("crypto_max");
    echo "\"\n                                            name=\"crypto_max\" placeholder=\"VD: 100000\">\n                                    </div>\n                                </div>\n                                <div class=\"row mb-4\">\n                                    <label class=\"col-sm-6 col-form-label\"\n                                        for=\"example-hf-email\">";
    echo __("1 USDT =");
    echo "</label>\n                                    <div class=\"col-sm-6\">\n                                        <div class=\"input-group\">\n                                            <input type=\"text\" class=\"form-control\"\n                                                value=\"";
    echo $CMSNT->site("crypto_rate");
    echo "\" name=\"crypto_rate\"\n                                                placeholder=\"VD: 23000\">\n                                            <span class=\"input-group-text\">\n                                                ";
    ...
    echo format_currency($CMSNT->get_row("SELECT SUM(received) FROM payment_crypto WHERE  `status` = 'completed' AND MONTH(create_gettime) = '" . $currentMonth . "' AND YEAR(create_gettime) = '" . $currentYear . "' ")["SUM(received)"]);
    echo "                                    </p>\n                                    <p class=\"mb-0 text-muted\">Tháng ";
    echo date("m");
    echo "</p>\n                                </div>\n                                <div class=\"ms-2\">\n                                    <span class=\"avatar text-bg-info rounded-circle fs-20\"><i\n                                            class='bx bxs-wallet-alt'></i></span>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n                <div class=\"col-xl-6\">\n                    <div class=\"card custom-card\">\n                        <div class=\"card-body\">\n                            <div class=\"d-flex align-items-center\">\n                                <div class=\"flex-fill\">\n                                    <p class=\"mb-1 fs-5 fw-semibold text-default\">\n                                        ";
    echo format_currency($CMSNT->get_row("SELECT SUM(received) FROM payment_crypto WHERE  `status` = 'completed' AND YEAR(create_gettime) = " . $currentYear . " AND WEEK(create_gettime, 1) = " . $currentWeek . " ")["SUM(received)"]);
