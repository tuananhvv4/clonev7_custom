...
$body = ["title" => __("Recharge Toyyibpay"), "desc" => "CMSNT Panel", "keyword" => "cmsnt, CMSNT, cmsnt.co,"];
...
if(isset($_POST["SaveSettings"])) {
    ...
    $CMSNT->insert("logs", ["user_id" => $getUser["id"], "ip" => myip(), "device" => $Mobile_Detect->getUserAgent(), "createdate" => gettime(), "action" => __("Cấu hình nạp tiền Toyyibpay")]);
    ...
    $currentYear = date("Y");
    $currentDate = date("Y-m-d");
    $total_yesterday = (int) $CMSNT->get_row("SELECT SUM(amount) FROM payment_toyyibpay WHERE  `status` = 1 AND `create_gettime` LIKE '%" . $yesterday . "%' ")["SUM(amount)"];
    ...
    echo "                                            is equal to how many RM</label>\n                                        <div class=\"col-sm-5\">\n                                            <div class=\"input-group\">\n                                                <input type=\"text\" class=\"form-control\"\n                                                    value=\"";
    echo $CMSNT->site("toyyibpay_rate");
    echo "\" name=\"toyyibpay_rate\"\n                                                    placeholder=\"5258\">\n                                                <span class=\"input-group-text\">\n                                                    RM\n                                                </span>\n                                            </div>\n                                        </div>\n                                    </div>\n                                    <div class=\"row mb-4\">\n                                        <label class=\"col-sm-7 col-form-label\"\n                                            for=\"example-hf-email\">";
    echo __("Minimum deposit amount");
    echo "</label>\n                                        <div class=\"col-sm-5\">\n                                            <div class=\"input-group\">\n                                                <input type=\"text\" class=\"form-control\"\n                                                    value=\"";
    echo $CMSNT->site("toyyibpay_min");
    echo "\" name=\"toyyibpay_min\"\n                                                    placeholder=\"1 = RM1\">\n                                                <span class=\"input-group-text\">\n                                                    RM\n                                                </span>\n                                            </div>\n                                            <small>1 = RM1</small>\n                                        </div>\n                                    </div>\n                                    <div class=\"row mb-4\">\n                                        <label class=\"col-sm-6 col-form-label\"\n                                            for=\"example-hf-email\">";
    echo __("FPX fee option");
    echo "</label>\n                                        <div class=\"col-sm-6\">\n                                            <select class=\"form-control\" name=\"toyyibpay_billChargeToCustomer\">\n                                                <option\n                                                    ";
    echo $CMSNT->site("toyyibpay_billChargeToCustomer") == "0" ? "selected" : "";
    echo "                                                    value=\"0\">Your customers pay a fee\n                                                </option>\n                                                <option\n                                                    ";
    echo $CMSNT->site("toyyibpay_billChargeToCustomer") == "" ? "selected" : "";
    echo "                                                    value=\"\">You pay fees\n                                                </option>\n                                            </select>\n                                        </div>\n                                    </div>\n                                </div>\n                                <div class=\"col-lg-12 col-xl-12\">\n                                    <div class=\"row mb-4\">\n                                        <label class=\"col-sm-6 col-form-label\"\n                                            for=\"example-hf-email\">";
    echo __("Toyyibpay Note");
    echo "</label>\n                                        <div class=\"col-sm-12\">\n                                            <textarea id=\"toyyibpay_notice\"\n                                                name=\"toyyibpay_notice\">";
    ...
    echo format_cash($CMSNT->get_row("SELECT SUM(amount) FROM payment_toyyibpay WHERE  `status` = 1 AND MONTH(create_gettime) = '" . $currentMonth . "' AND YEAR(create_gettime) = '" . $currentYear . "' ")["SUM(amount)"]);
    echo "                                            RM\n                                        </p>\n                                        <p class=\"mb-0 text-muted\">Tháng ";
    echo date("m");
    echo "</p>\n                                    </div>\n                                    <div class=\"ms-2\">\n                                        <span class=\"avatar text-bg-info rounded-circle fs-20\"><i\n                                                class='bx bxs-wallet-alt'></i></span>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"col-xl-6\">\n                        <div class=\"card custom-card\">\n                            <div class=\"card-body\">\n                                <div class=\"d-flex align-items-center\">\n                                    <div class=\"flex-fill\">\n                                        <p class=\"mb-1 fs-5 fw-semibold text-default\">\n                                            ";
    echo format_cash($CMSNT->get_row("SELECT SUM(amount) FROM payment_toyyibpay WHERE  `status` = 1 AND YEAR(create_gettime) = " . $currentYear . " AND WEEK(create_gettime, 1) = " . $currentWeek . " ")["SUM(amount)"]);
    ...
    echo $trans_id;
    echo "\" name=\"trans_id\"\n                                        placeholder=\"";
    echo __("Search trans id");
    echo "\">\n                                </div>\n                                <div class=\"col-md-3 col-6\">\n                                    <input class=\"form-control form-control-sm\" value=\"";
    echo $BillCode;
    echo "\" name=\"BillCode\"\n                                        placeholder=\"";
    echo __("Search bill code");
    echo "\">\n                                </div>\n                                <div class=\"col-md-3 col-6\">\n                                    <input class=\"form-control form-control-sm\" value=\"";
    echo $billName;
    echo "\" name=\"billName\"\n                                        placeholder=\"";
    echo __("Search bill name");
    echo "\">\n                                </div>\n                                <div class=\"col-md-3 col-6\">\n                                    <input class=\"form-control form-control-sm\" value=\"";
    echo $amount;
    echo "\" name=\"amount\"\n                                        placeholder=\"";
    echo __("Search amount");
    echo "\">\n                                </div>\n                                <div class=\"col-md-3 col-6\">\n                                    <select class=\"form-control form-control-sm\" name=\"status\">\n                                        <option value=\"\">";
    echo __("Search by status");
    echo "</option>\n                                        <option ";
