...
$body = ["title" => __("Recharge Perfect Money"), "desc" => "CMSNT Panel", "keyword" => "cmsnt, CMSNT, cmsnt.co,"];
...
if(isset($_POST["SaveSettings"])) {
    ...
    $CMSNT->insert("logs", ["user_id" => $getUser["id"], "ip" => myip(), "device" => $Mobile_Detect->getUserAgent(), "createdate" => gettime(), "action" => __("Cấu hình nạp tiền Perfect Money")]);
    ...
    $currentYear = date("Y");
    $currentDate = date("Y-m-d");
    $total_yesterday = (int) $CMSNT->get_row("SELECT SUM(price) FROM payment_pm WHERE `status` = 1 AND `create_date` LIKE '%" . $yesterday . "%' ")["SUM(price)"];
    ...
    echo $CMSNT->site("perfectmoney_status") == 1 ? "selected" : "";
    echo "                                                    value=\"1\">ON\n                                                </option>\n                                                <option ";
    echo $CMSNT->site("perfectmoney_status") == 0 ? "selected" : "";
    echo "                                                    value=\"0\">OFF\n                                                </option>\n                                            </select>\n                                        </div>\n                                    </div>\n                                    <div class=\"row mb-4\">\n                                        <label class=\"col-sm-4 col-form-label\"\n                                            for=\"example-hf-email\">";
    echo __("1 USD =");
    echo "</label>\n                                        <div class=\"col-sm-8\">\n                                            <div class=\"input-group\">\n                                                <input type=\"text\" class=\"form-control\"\n                                                    value=\"";
    echo $CMSNT->site("perfectmoney_rate");
    ...
    echo "                                                </span>\n                                            </div>\n                                        </div>\n                                    </div>\n                                    <div class=\"row mb-4\">\n                                        <label class=\"col-sm-4 col-form-label\"\n                                            for=\"example-hf-email\">";
    echo __("Đơn vị tiền tệ");
    echo "</label>\n                                        <div class=\"col-sm-8\">\n                                            <div class=\"input-group\">\n                                                <input type=\"text\" class=\"form-control\"\n                                                    value=\"";
    echo $CMSNT->site("perfectmoney_units");
    echo "\"\n                                                    name=\"perfectmoney_units\" placeholder=\"VD: USD\">\n                                            </div>\n                                        </div>\n                                    </div>\n                                </div>\n                                <div class=\"col-lg-12 col-xl-6\">\n                                    <div class=\"row mb-4\">\n                                        <label class=\"col-sm-5 col-form-label\"\n                                            for=\"example-hf-email\">";
    echo __("Mã tài khoản Perfect Money");
    echo "</label>\n                                        <div class=\"col-sm-7\">\n                                            <input type=\"text\" class=\"form-control\"\n                                                value=\"";
    echo $CMSNT->site("perfectmoney_account");
    echo "\"\n                                                name=\"perfectmoney_account\" placeholder=\"VD: U36599423\">\n                                        </div>\n                                    </div>\n                                    <div class=\"row mb-4\">\n                                        <label class=\"col-sm-5 col-form-label\"\n                                            for=\"example-hf-email\">";
    echo __("Mật khẩu Thay thế (Alternate Passphrase)");
    echo "</label>\n                                        <div class=\"col-sm-7\">\n                                            <input type=\"text\" class=\"form-control\"\n                                                value=\"";
    echo $CMSNT->site("perfectmoney_pass");
    echo "\" name=\"perfectmoney_pass\"\n                                                placeholder=\"";
    echo __("Nhập mật khẩu thay thế");
    echo "\">\n                                        </div>\n                                    </div>\n                                </div>\n                                <div class=\"col-lg-12 col-xl-12\">\n                                    <div class=\"row mb-4\">\n                                        <label class=\"col-sm-6 col-form-label\"\n                                            for=\"example-hf-email\">";
    echo __("Perfect Money Note");
    echo "</label>\n                                        <div class=\"col-sm-12\">\n                                            <textarea id=\"perfectmoney_notice\"\n                                                name=\"perfectmoney_notice\">";
    ...
    echo format_currency($CMSNT->get_row("SELECT SUM(price) FROM payment_pm WHERE `status` = 1 AND MONTH(create_date) = '" . $currentMonth . "' AND YEAR(create_date) = '" . $currentYear . "' ")["SUM(price)"]);
    echo "                                        </p>\n                                        <p class=\"mb-0 text-muted\">Tháng ";
    echo date("m");
    echo "</p>\n                                    </div>\n                                    <div class=\"ms-2\">\n                                        <span class=\"avatar text-bg-info rounded-circle fs-20\"><i\n                                                class='bx bxs-wallet-alt'></i></span>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"col-xl-6\">\n                        <div class=\"card custom-card\">\n                            <div class=\"card-body\">\n                                <div class=\"d-flex align-items-center\">\n                                    <div class=\"flex-fill\">\n                                        <p class=\"mb-1 fs-5 fw-semibold text-default\">\n                                            ";
    echo format_currency($CMSNT->get_row("SELECT SUM(price) FROM payment_pm WHERE `status` = 1 AND YEAR(create_date) = " . $currentYear . " AND WEEK(create_date, 1) = " . $currentWeek . " ")["SUM(price)"]);
